                            ...
                            createOrder={(data, actions) => {
                              return actions.order.create({
                                purchase_units: [
                                  {
                                    amount: {
                                      currency_code: "USD", // Xác định thanh toán bằng USD
                                      value: amountUSD, // Số tiền thanh toán tính bằng USD
                            ...
                            onApprove={async (data, actions) => {
                              try {
                                ...
                                const orderData = {
                                  ...
                                  total: totalVND, // Lưu vào DB bằng VND
                                  note: obj.note || "",
                                  isPending: true,
                                  payment: "paypal",
                                  accountId: props.user ? props.user.id : -1,
                                ...
                                // Đóng Modal sau khi đơn hàng được tạo thành công
                                handleCloseFirst();
